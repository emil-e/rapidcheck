        ...
        templatedProp<T>(
            ...
            [](const Random &random) {
                ...
                for (int i = 0; i <= kNominalSize; i++) {
                    AbsT value = absolute(
                        gen::arbitrary<T>()(random, i).value());
    ...
    static void exec()
    {
        templatedProp<T>(
            ...
            [](const GenParams &params) {
                ...
                const auto value = gen::inRange<T>(
...
struct NonZeroProperties
{
    ...
    static void exec()
    {
        templatedProp<T>(
            ...
            [=](const GenParams &params) {
                const auto shrinkable = gen::nonZero<T>()(
                    params.random, params.size);
                onAnyPath(
                    shrinkable,
...
struct PositiveProperties
{
    ...
    static void exec()
    {
        templatedProp<T>(
            ...
            [=](const GenParams &params) {
                const auto shrinkable = gen::positive<T>()(
                    params.random, params.size);
                onAnyPath(
                    shrinkable,
                    [](const Shrinkable<T> &value,
...
struct NegativeProperties
{
    ...
    static void exec()
    {
        templatedProp<T>(
            ...
            [=](const GenParams &params) {
                const auto shrinkable = gen::negative<T>()(
                    params.random, params.size);
                onAnyPath(
                    shrinkable,
                    [](const Shrinkable<T> &value,
...
struct NonNegativeProperties
{
    ...
    static void exec()
    {
        templatedProp<T>(
            ...
            [=](const GenParams &params) {
                const auto shrinkable = gen::nonNegative<T>()(
                    params.random, params.size);
                onAnyPath(
                    shrinkable,
                    [](const Shrinkable<T> &value,

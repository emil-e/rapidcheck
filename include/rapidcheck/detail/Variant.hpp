...
Variant<Type, Types...>::Variant(T &&value)
...
template<typename Type, typename ...Types>
template<typename T, typename>
Variant<Type, Types...> &Variant<Type, Types...>::operator=(const T &value) noexcept
{
...
template<typename Type, typename ...Types>
template<typename T, typename>
Variant<Type, Types...> &Variant<Type, Types...>::operator=(T &&value) noexcept
{
    static_assert(isValidType<T>(),
                  "T is not a valid type of this variant");
...
template<typename Type, typename ...Types>
Variant<Type, Types...>::Variant(const Variant &other)
    noexcept(AllIs<std::is_nothrow_copy_constructible, Type, Types...>::value)
    : m_typeIndex(other.m_typeIndex)
{ copy(m_typeIndex, &m_storage, &other.m_storage); }

template<typename Type, typename ...Types>
Variant<Type, Types...>::Variant(Variant &&other)
    noexcept(AllIs<std::is_nothrow_move_constructible, Type, Types...>::value)
    : m_typeIndex(other.m_typeIndex)
{ move(m_typeIndex, &m_storage, &other.m_storage); }

template<typename Type, typename ...Types>
Variant<Type, Types...> &Variant<Type, Types...>::operator=(const Variant &rhs)
    noexcept(AllIs<std::is_nothrow_copy_constructible, Type, Types...>::value &&
...
template<typename Type, typename ...Types>
Variant<Type, Types...> &Variant<Type, Types...>::operator=(Variant &&rhs)
    noexcept(AllIs<std::is_nothrow_move_assignable, Type, Types...>::value)
{
    static_assert(
        AllIs<std::is_nothrow_move_constructible, Type, Types...>::value,
        "AllIs types must be nothrow move-constructible to use copy assignment");
...
template<typename Type, typename ...Types>
Variant<Type, Types...>::~Variant() noexcept { destroy(m_typeIndex, &m_storage); }
...
template<typename Type, typename ...Types>
void Variant<Type, Types...>::moveAssign(std::size_t index, void *to, void *from)
{
    static void (* const moveAssignFuncs[])(void *, void *) = {
        &variantMoveAssign<Type>,
...
template<typename Type, typename ...Types>
void Variant<Type, Types...>::destroy(std::size_t index, void *storage) noexcept
{

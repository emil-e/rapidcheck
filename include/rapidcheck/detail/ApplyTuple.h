...
template <typename TupleT,
    typename Callable,
    typename Indexes = MakeIndexSequence<std::tuple_size<Decay<TupleT>>::value>>
...
typename ApplyTupleImpl<TupleT, Callable>::ReturnType applyTuple(
    TupleT &&tuple, Callable &&callable) {

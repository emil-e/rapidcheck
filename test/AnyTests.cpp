...
TEST_CASE("Any") {
    ...
    SECTION("operator==/operator!=") {
        SECTION("null equals null") {
            REQUIRE(Any() == Any());
            REQUIRE_FALSE(Any() != Any());
        }

        SECTION("null does not equal non-null") {
            REQUIRE_FALSE(Any() == Any::of(123));
            REQUIRE_FALSE(Any::of(123) == Any());

            REQUIRE(Any() != Any::of(123));
            REQUIRE(Any::of(123) != Any());
        }

        SECTION("equals if contained values are equal") {
            REQUIRE(Any::of(123) == Any::of(123));
            REQUIRE(Any::of<std::string>("foo") == Any::of<std::string>("foo"));

            REQUIRE_FALSE(Any::of(123) != Any::of(123));
            REQUIRE_FALSE(Any::of<std::string>("foo") != Any::of<std::string>("foo"));
        }

        SECTION("not equals if contained values are not equal") {
            REQUIRE_FALSE(Any::of(123) == Any::of(1234));
            REQUIRE_FALSE(Any::of(1234) == Any::of(123));
            REQUIRE_FALSE(Any::of<std::string>("foo") ==
                          Any::of<std::string>("bar"));
            REQUIRE_FALSE(Any::of<std::string>("bar") ==
                          Any::of<std::string>("foo"));

            REQUIRE(Any::of(123) != Any::of(1234));
            REQUIRE(Any::of(1234) != Any::of(123));
            REQUIRE(Any::of<std::string>("foo") !=
                    Any::of<std::string>("bar"));
            REQUIRE(Any::of<std::string>("bar") !=
                    Any::of<std::string>("foo"));
        }

        SECTION("not equals if contained values are not of same type") {
            REQUIRE_FALSE(Any::of(123) == Any::of<std::string>("123"));
            REQUIRE_FALSE(Any::of<std::string>("123") == Any::of(123));

            REQUIRE(Any::of(123) != Any::of<std::string>("123"));
            REQUIRE(Any::of<std::string>("123") != Any::of(123));

            // Not even if they can be compared normally
            REQUIRE(Apple("foo") == Orange("foo"));
            REQUIRE_FALSE(Any::of<Apple>("foo") == Any::of<Orange>("foo"));
            REQUIRE_FALSE(Apple("foo") != Orange("foo"));
            REQUIRE(Any::of<Apple>("foo") != Any::of<Orange>("foo"));
        }

        SECTION("not equals if contained values do not support operator==") {
            REQUIRE_FALSE(Any::of<NonComparable>("foo") ==
                          Any::of<NonComparable>("foo"));

            REQUIRE(Any::of<NonComparable>("foo") !=
                    Any::of<NonComparable>("foo"));
        }
    }
}
